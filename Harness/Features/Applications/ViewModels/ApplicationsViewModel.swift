    ...
    func rename(_ applicationID: UUID, to newName: String) async -> Bool {
        ...
        do {
            ...
            current = ApplicationSnapshot(
                ...
                platformKindRaw: current.platformKindRaw,
                ...
                macAppBundlePath: current.macAppBundlePath,
                macAppBundleBookmark: current.macAppBundleBookmark,
                webStartURL: current.webStartURL,
                webViewportWidthPt: current.webViewportWidthPt,
                webViewportHeightPt: current.webViewportHeightPt,
