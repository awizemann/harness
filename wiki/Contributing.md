...
Thanks for the interest. Harness is a native macOS dev tool that drives iOS Simulators, macOS apps, and web apps with an AI agent to run real-user-style tests. This doc covers what you need to build, contribute, and ship changes that fit the project.
...
- [`standards/01-architecture.md`](../standards/01-architecture.md) — module rules; **features never import sibling feature modules**.
