...
> **v0.5.0 shipped 2026-05-21** — Local Mac inference via Ollama, Set-of-Mark targeting on iOS + macOS + web, and `harness-cli` dev-time driver. See [the release](https://github.com/awizemann/harness/releases/tag/v0.5.0).
...
**v0.5.0 alpha.** All three target platforms wired end-to-end with feature-parity scaffolding for the agent. Highlights since 0.1:
...
_Last updated: 2026-05-21 — v0.5.0 release_