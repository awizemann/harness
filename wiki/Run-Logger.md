...
The schema is in [Run-Replay-Format](Run-Replay-Format). The integrity invariants are in [`../standards/08-run-log-integrity.md`](https://github.com/awizemann/harness/blob/main/standards/08-run-log-integrity.md).
...
- [Run-Replay-Format](Run-Replay-Format) — the JSONL schema this writer emits.
- [`../standards/08-run-log-integrity.md`](https://github.com/awizemann/harness/blob/main/standards/08-run-log-integrity.md) — invariants.
- [`../standards/14-run-logging-format.md`](https://github.com/awizemann/harness/blob/main/standards/14-run-logging-format.md) — schema.
- [Agent-Loop](Agent-Loop) — what's calling this writer.
