...
- [`../standards/03-subprocess-and-filesystem.md`](https://github.com/awizemann/harness/blob/main/standards/03-subprocess-and-filesystem.md) — `ProcessRunner` ownership rules.
- [Simulator-Driver](Simulator-Driver) — the downstream consumer of the `.app` bundle.
- [Build-and-Run](Build-and-Run) — instructions for running Harness against a local sample app.
