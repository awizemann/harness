...
Wraps `xcrun simctl` (lifecycle) and **WebDriverAgent** (input). The standard at [`../standards/12-simulator-control.md`](https://github.com/awizemann/harness/blob/main/standards/12-simulator-control.md) is the canonical reference for invariants. This page is the implementation deep-dive — concrete commands, error modes, the coordinate-scaling math, and the WDA lifecycle.
...
All `simctl` / `xcodebuild` calls go through `ProcessRunner` per [`../standards/03-subprocess-and-filesystem.md`](https://github.com/awizemann/harness/blob/main/standards/03-subprocess-and-filesystem.md). All HTTP calls go through `WDAClient` (`Harness/Services/WDAClient.swift`).
...
- [`../standards/12-simulator-control.md`](https://github.com/awizemann/harness/blob/main/standards/12-simulator-control.md) — full standard.
- [Xcode-Builder](Xcode-Builder) — the upstream service that produces the `.app` bundle.
- [Build-and-Run](Build-and-Run) — first-run setup, including the WDA build estimate.
- [`../Harness/Services/WDAClient.swift`](https://github.com/awizemann/harness/blob/main/Harness/Services/WDAClient.swift), [`WDARunner.swift`](https://github.com/awizemann/harness/blob/main/Harness/Services/WDARunner.swift), [`WDABuilder.swift`](https://github.com/awizemann/harness/blob/main/Harness/Services/WDABuilder.swift) — the WDA stack.
